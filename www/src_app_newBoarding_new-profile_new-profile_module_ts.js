    ...
    this.appservice.getProfile().then(res => {
      ...
      this.storage.get("localData").then(val => {
        ...
        if (this.clientId !== "enkeltec" && this.clientId !== "plixkids") {
          ...
          this.profileData.lifeStyle.activities = this.compConfig?.activities?.find(item => activitiesCode === item.code);
          console.log("this.profileData.lifeStyle.activities", activitiesCode, this.compConfig, this.profileData.lifeStyle.activities);
        } else {
        ...
        if (this.clientId === "plixkids") {
          this.profileData.lifeStyle.diseases = [...this.profileData.lifeStyle.diseases].filter(item => {
