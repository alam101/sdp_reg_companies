    ...
    goNext() {
        for (let index = 0; index < this.localData.otherMaster.diseases.length; index++) {
            for (let b = 0; b < this.trayaAllergies.length; b++) {
                if (this.localData.otherMaster.diseases[index].code ===
