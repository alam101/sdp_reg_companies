  ...
  getProfile() {
    ...
    this.appservice.getProfile().then((res) => {
      ...
      this.storage.get("localData").then((val) => {
        ...
        this.profileData.lifeStyle.foodType =
          this.localData?.otherMaster?.foodPref.find(
        ...
        const communitiesItem = JSON.parse(
          localStorage.getItem("communitiesItem"),
        );
        if (
          communitiesItem != undefined &&
          communitiesItem != "" &&
          communitiesItem != null
        ) {
