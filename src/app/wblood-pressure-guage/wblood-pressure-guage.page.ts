...
import { WbloodPressureLogPage } from "../wblood-pressure-log/wblood-pressure-log.page";

@Component({
  selector: "app-wblood-pressure-guage",
  templateUrl: "./wblood-pressure-guage.page.html",
  styleUrls: ["./wblood-pressure-guage.page.scss"],
})
export class WbloodPressureGuagePage implements AfterViewInit {
  ...
  bloodPressureGraph() {
    ...
    this.appService.getHealthData(this.profileData.profile.email).then(
      (res: any) => {
        this.healthData = res.sort(
          (a, b) =>
