...
import { WbloodGlucoseLogPage } from "../wblood-glucose-log/wblood-glucose-log.page";
@Component({
  selector: "app-wblood-glucose-guage",
  templateUrl: "./wblood-glucose-guage.page.html",
  styleUrls: ["./wblood-glucose-guage.page.scss"],
})
export class WbloodGlucoseGuagePage implements AfterViewInit {
